...
void PointLight::sendLightInfo(GLuint program, Material* mat, int index)//Manda informações sobre a luz usando array de structs. FONTE Adaptado de https://learnopengl.com/Lighting/Multiple-lights
{
